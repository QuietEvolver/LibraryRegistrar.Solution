...
namespace LibraryRegistrar.Tests
{
  [TestClass]
  public class ItemTest : IDisposable
  {
    ...
    public ItemTest()
    {
      DBConfiguration.ConnectionString = "server=localhost;user id=root;password=epicodus;port=3306;database=library_registrar_testdb;";
    }
